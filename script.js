...
console.log("DEBUG: script.js caricato!");

// Aspetta che il DOM sia caricato
window.addEventListener('DOMContentLoaded', () => {
    console.log("DEBUG: DOM caricato, inizializzo Aiko...");
    ...
    // Verifica elementi
    if (!talkButton) {
        console.error("ERRORE: Pulsante PARLA non trovato!");
        return;
    }
    ...
    // Event listeners
    console.log("DEBUG: Aggiungo event listeners...");
    talkButton.addEventListener('click', () => {
        console.log("DEBUG: Click su PARLA!");
        startConversation();
    });

    endButton.addEventListener('click', () => {
        console.log("DEBUG: Click su CHIUDI!");
        endConversation();
    });
    ...
    console.log("DEBUG: Inizializzazione completata!");
}); 